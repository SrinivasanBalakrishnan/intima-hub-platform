              ...
              <div className="flex justify-between items-center mb-1">
                {/* Doctor Name & Verified Badge */}
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <div className="group/badge relative z-50">
                      <div className="flex items-center gap-1 bg-green-500/10 border border-green-500/20 text-green-400 text-[10px] px-2 py-0.5 rounded-full cursor-help hover:bg-green-500/20 transition-colors">
                      ...
                      {/* Floating License Tooltip */}
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover/badge:block w-48 bg-zinc-900 text-center p-3 rounded-lg border border-zinc-700 shadow-[0_0_20px_rgba(0,0,0,1)]">
                        <p className="text-[10px] text-zinc-500 uppercase tracking-widest mb-1">Medical License Verified</p>
                        <p className="text-xs font-mono text-white tracking-wider">NMC-{88402 + (typeof i !== 'undefined' ? i : 0)}-NY</p>
